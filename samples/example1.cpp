...
public:
	FragmentAssembler(Jit &parent, const std::string &fragmentName, bool optimize);
	~FragmentAssembler();
...
FragmentAssembler::FragmentAssembler(Jit &parent, const std::string &fragmentName, bool optimize)
...
LIns *
FragmentAssembler::ret(ReturnType rt, LIns *result)
{
	returnTypeBits_ |= rt;
	LOpcode opcode;
	switch (rt) {
...
GuardRecord*
FragmentAssembler::createGuardRecord(SideExit *exit)
{
